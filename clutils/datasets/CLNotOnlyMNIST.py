...
class _CLImageDataset(Dataset):
    ...
    def __init__(self, pixel_in_input=1, perc_test=0.2, train_batch_size=3, test_batch_size=0,
            ...
            len_task_vector=0, task_vector_at_test=False, return_sequences=True, num_workers=0, pin_memory=False):
        '''
    ...
    def _get_test_loader(self, perm=None):
        ...
        if self.test_batch_size == 0:
            return DataLoader(test_dataset, batch_size=len(self.mytest_targets), shuffle=False, num_workers=self.num_workers, pin_memory=self.pin_memory)
        else:
            return DataLoader(test_dataset, batch_size=self.test_batch_size, shuffle=False, drop_last=True, num_workers=self.num_workers, pin_memory=self.pin_memory)
    ...
    def _get_train_loader(self, perm=None):
        ...
        cl_loader_train = DataLoader(train_dataset, batch_size=train_batch_size, shuffle=True, drop_last=True, num_workers=self.num_workers, pin_memory=self.pin_memory)
...
class CLMNIST(MNIST, _CLImageDataset):
    def __init__(self, root, download, pixel_in_input=1, perc_test=0.2, train_batch_size=3, test_batch_size=0,
            ...
            task_vector_at_test=False, return_sequences=True, num_workers=0, pin_memory=False):
        '''
