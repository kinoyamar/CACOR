...
def speech_words_exp(args, is_aco=False):
    """
    ...
    The dataset is from https://www.kaggle.com/jbuchner/synthetic-speech-commands-dataset
    """
    N_MELS = 40
    ...
    dataset = clutils.datasets.CLSpeechWords(os.path.expanduser(args.dataroot), perc_test=0.2, train_batch_size=args.batch_size,
            test_batch_size=256, n_mels=N_MELS,  len_task_vector=0,
            task_vector_at_test=False, return_sequences=model.is_recurrent)
